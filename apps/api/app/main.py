...
from app.modules.authentication.web_router import router as web_authentication_router
...
def create_app() -> FastAPI:
    ...
    application.include_router(web_authentication_router, prefix="/api/v1")
