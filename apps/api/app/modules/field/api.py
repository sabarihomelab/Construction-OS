...
from app.modules.field.dpr_custom_field_router import router as dpr_custom_field_router
...
from app.modules.field.dpr_photo_resumable_router import router as dpr_photo_resumable_router
...
router = APIRouter()
router.include_router(dpr_custom_field_router)
...
router.include_router(dpr_photo_resumable_router)
