...
_BASE_PERMISSION_CATALOG: tuple[PermissionSpec, ...] = (
    ...
    PermissionSpec(key="field.dpr.template.view", module="field", resource="dpr_template", action="view", description="View effective DPR report templates, layout contracts and branding.", risk=PermissionRisk.MEDIUM),
    PermissionSpec(key="field.dpr.template.manage", module="field", resource="dpr_template", action="manage", description="Create, version and publish DPR report templates and company branding.", risk=PermissionRisk.HIGH),
    PermissionSpec(key="field.dpr.render", module="field", resource="dpr_report", action="render", description="Generate permission-scoped DPR print and issued outputs.", risk=PermissionRisk.HIGH),
    ...
    PermissionSpec(key="workforce.attendance.view", module="workforce", resource="attendance", action="view", description="View project daily attendance registers and approved DPR summaries.", risk=PermissionRisk.MEDIUM),
    PermissionSpec(key="workforce.attendance.create", module="workforce", resource="attendance", action="create", description="Create project daily attendance registers from active Worker assignments.", risk=PermissionRisk.MEDIUM),
    PermissionSpec(key="workforce.attendance.update", module="workforce", resource="attendance", action="update", description="Bulk mark and correct draft or rejected project attendance.", risk=PermissionRisk.HIGH),
    PermissionSpec(key="workforce.attendance.submit", module="workforce", resource="attendance", action="submit", description="Submit completed project attendance under configured approval rules.", risk=PermissionRisk.HIGH),
    PermissionSpec(key="workforce.attendance.approve", module="workforce", resource="attendance", action="approve", description="Approve or reject project attendance through the configured workflow.", risk=PermissionRisk.HIGH),
    PermissionSpec(key="workforce.attendance.reopen", module="workforce", resource="attendance", action="reopen", description="Reopen submitted or approved attendance for controlled correction and resubmission.", risk=PermissionRisk.CRITICAL),
