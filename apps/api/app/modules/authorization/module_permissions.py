...
MODULE_PERMISSION_DEFINITIONS: tuple[ModulePermissionDefinition, ...] = (
    ...
    ModulePermissionDefinition("commercial.ra_bill.certify", "commercial", "ra_bill", "certify", "Certify submitted RA bills.", PermissionRisk.CRITICAL),
    ModulePermissionDefinition("commercial.ra_bill.payment", "commercial", "ra_bill", "payment", "Record payment state for certified RA bills.", PermissionRisk.CRITICAL),
