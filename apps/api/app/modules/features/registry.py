...
FEATURE_REGISTRY: tuple[FeatureSpec, ...] = (
    ...
    FeatureSpec(key="field", name="Field Operations", kind=FeatureKind.MODULE, route="/field", required_permissions=("field.daily_report.view",), release_state=FeatureReleaseState.PLANNED, display_order=200, offline_enabled=True, help_topic="field"),
    FeatureSpec(key="workforce", name="Workforce & Time", kind=FeatureKind.MODULE, route="/workforce", required_permissions=("workforce.worker.view",), release_state=FeatureReleaseState.PLANNED, display_order=220, offline_enabled=True, help_topic="workforce"),
    ...
    FeatureSpec(key="estimating", name="Estimating / Rate Analysis / Budget", kind=FeatureKind.MODULE, route="/estimating", required_permissions=("estimating.module.view",), release_state=FeatureReleaseState.PLANNED, sensitivity=FeatureSensitivity.HIGH, display_order=320, offline_enabled=True, help_topic="estimating"),
    ...
    FeatureSpec(key="financials", name="Financials", kind=FeatureKind.MODULE, route="/financials", required_permissions=("finance.budget.view",), release_state=FeatureReleaseState.PLANNED, sensitivity=FeatureSensitivity.HIGH, display_order=500, mobile_enabled=False, help_topic="financials"),
