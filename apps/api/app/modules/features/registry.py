...
FEATURE_REGISTRY: tuple[FeatureSpec, ...] = (
    ...
    FeatureSpec(key="workforce.attendance", name="Attendance", kind=FeatureKind.PAGE, route="/field/attendance", required_permissions=("workforce.attendance.view",), tenant_configurable=False, release_state=FeatureReleaseState.AVAILABLE, display_order=225, offline_enabled=True, help_topic="workforce.attendance"),
    ...
    FeatureSpec(key="admin.roles_access", name="Roles & Access", kind=FeatureKind.PAGE, parent_key="admin", route="/admin/access", required_permissions=("security.role.view",), tenant_configurable=False, sensitivity=FeatureSensitivity.SENSITIVE, display_order=910, mobile_enabled=False, help_topic="admin.roles_access"),
