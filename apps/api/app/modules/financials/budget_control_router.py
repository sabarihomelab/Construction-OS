...
from app.modules.financials.budget_control import build_budget_commercial_control
from app.modules.financials.budget_control_schemas import BudgetCommercialControlSummary
...
@router.get(
    "/projects/{project_id}/financials/commercial-control/budget",
    response_model=BudgetCommercialControlSummary,
)
async def get_budget_commercial_control(
    project_id: UUID,
    db: DbSession,
    ...
    try:
        return await build_budget_commercial_control(
            db,
