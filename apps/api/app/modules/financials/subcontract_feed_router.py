...
from app.modules.financials.subcontract_cost_feeds import post_subcontract_claim_cost
from app.modules.financials.subcontract_feed_schemas import SubcontractClaimCostPost
...
@router.post(
    "/projects/{project_id}/financials/job-cost/from-subcontract-claims/{claim_id}",
    response_model=ProjectCostRead,
)
async def post_subcontract_claim_job_cost(
    project_id: UUID,
    claim_id: UUID,
    payload: SubcontractClaimCostPost,
    db: DbSession,
    ...
    try:
        row = await post_subcontract_claim_cost(
            db,
            organization_id=context.organization_id,
            project_id=project_id,
            claim_id=claim_id,
            subcontract_cost_head_id=payload.subcontract_cost_head_id,
