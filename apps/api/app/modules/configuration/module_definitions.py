...
MODULE_CONFIGURATION_DEFINITIONS: tuple[ModuleConfigurationDefinition, ...] = (
    ...
    ModuleConfigurationDefinition(
        ...
        change_class=ConfigurationChangeClass.WORKFLOW,
        max_length=160,
        description="Shared Workflow transition used to reject an inspection for correction.",
    ),
    ModuleConfigurationDefinition(
    ...
    ModuleConfigurationDefinition(
        key="estimating.rate_analysis.default_wastage_percent",
        module_key="estimating",
        value_type="decimal",
        default=Decimal(0),
        change_class=ConfigurationChangeClass.BUSINESS_RULE,
        min_value=Decimal(0),
        max_value=Decimal(100),
        description="Default wastage percentage proposed for new rate-analysis versions. Approved estimates retain the actual percentage used.",
    ),
    ModuleConfigurationDefinition(
        key="estimating.rate_analysis.default_overhead_percent",
        module_key="estimating",
        value_type="decimal",
        default=Decimal(0),
        change_class=ConfigurationChangeClass.BUSINESS_RULE,
        min_value=Decimal(0),
        max_value=Decimal(100),
        description="Default overhead percentage proposed for new rate-analysis versions. Approved estimates retain the actual percentage used.",
    ),
    ModuleConfigurationDefinition(
        key="estimating.rate_analysis.default_profit_percent",
        module_key="estimating",
        value_type="decimal",
        default=Decimal(0),
        change_class=ConfigurationChangeClass.BUSINESS_RULE,
        min_value=Decimal(0),
        max_value=Decimal(100),
        description="Default profit percentage proposed for new rate-analysis versions. Profit remains excluded from the project cost budget.",
    ),
    ModuleConfigurationDefinition(
        key="workforce.attendance.require_wbs",
        module_key="workforce",
        value_type="boolean",
        default=False,
        change_class=ConfigurationChangeClass.BUSINESS_RULE,
        description="Require working attendance marks to be allocated to an active project WBS / Cost Code.",
    ),
    ModuleConfigurationDefinition(
        key="workforce.attendance.approval.required",
        module_key="workforce",
        value_type="boolean",
        default=False,
        change_class=ConfigurationChangeClass.WORKFLOW,
        description="Whether submitted daily attendance must pass through the shared Workflow engine.",
    ),
    ModuleConfigurationDefinition(
        key="workforce.attendance.workflow.definition_key",
        module_key="workforce",
        value_type="string",
        default="",
        change_class=ConfigurationChangeClass.WORKFLOW,
        max_length=160,
        description="Published shared Workflow definition used for attendance review.",
    ),
    ModuleConfigurationDefinition(
        key="workforce.attendance.workflow.approve_transition_key",
        module_key="workforce",
        value_type="string",
        default="",
        change_class=ConfigurationChangeClass.WORKFLOW,
        max_length=160,
        description="Shared Workflow transition used to approve daily attendance.",
    ),
    ModuleConfigurationDefinition(
        key="workforce.attendance.workflow.reject_transition_key",
        module_key="workforce",
        value_type="string",
        default="",
        change_class=ConfigurationChangeClass.WORKFLOW,
        max_length=160,
        description="Shared Workflow transition used to reject daily attendance for correction.",
    ),
    ModuleConfigurationDefinition(
        key="workforce.attendance.workflow.resubmit_transition_key",
        module_key="workforce",
        value_type="string",
        default="",
        change_class=ConfigurationChangeClass.WORKFLOW,
        max_length=160,
        description="Shared Workflow transition used to resubmit corrected attendance.",
    ),
)
